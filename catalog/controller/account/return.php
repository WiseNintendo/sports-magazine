...
class ControllerAccountReturn extends Controller {
	...
	public function add() {
		...
		$this->document->addScript('catalog/view/javascript/gijgo.min.js');
		$this->document->addScript('catalog/view/javascript/messages.ru-ru.js');
		$this->document->addStyle('catalog/view/theme/default/stylesheet/gijgo.min.css');
